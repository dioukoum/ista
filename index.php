...
if (isset($_POST['connexion'])) {
    if (isset($_POST['login'], $_POST['password'])) {
        $req = $bd->query('select * from utilisateur where login="' . $_POST['login'] . '"and password="' . $_POST['password'] . '"');
        if ($ligne = $req->fetch()) {
                ...
                <section class="login_content">
                    <form action="index.php" method="post">
                        ...
                        <div class="separator">
                            ...
                            <div>
                                <h1><i class="fa fa-paw"></i> Technolab ISTA</h1>
                    ...
                    <form>
                        ...
                        <div class="separator">
                            <p class="change_link">Already a member ?
                                <button href="#signin" class="to_register"> Log in </button>
                            </p>
